...
| Feature | Description |
|---|---|
| `character_count` | Number of characters in a statement |
| `word_count` | Number of words in a statement |
| `sentence_count` | Estimated number of sentences |
| `cleaned_statement` | Preprocessed text |
...
| `cleaned_statement` | Preprocessed statement |
...
- `Sentiment_Analysis_NLP.ipynb` — Python, NLP, EDA, TF-IDF, machine learning, and model evaluation.
- `Sentiment_Analysis_Cleaned.csv` — cleaned and feature-engineered dataset.
